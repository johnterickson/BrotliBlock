...
namespace System.IO.Compression
{
    ...
    public sealed partial class BrotliBlockStream : Stream
    {
        ...
        public BrotliBlockStream(Stream stream, CompressionLevel compressionLevel) : this(stream, compressionLevel, leaveOpen: false) { }
        ...
        /// <exception cref="ArgumentNullException"><paramref name="stream"/> is <see langword="null" />.</exception>
        public BrotliBlockStream(Stream stream, CompressionLevel compressionLevel, bool leaveOpen) : this(stream, CompressionMode.Compress, leaveOpen)
        {
        ...
        public BrotliBlockStream(Stream stream, BrotliCompressionOptions compressionOptions, bool leaveOpen = false) : this(stream, CompressionMode.Compress, leaveOpen)
        {
            ...
            _encoder.SetParameter(BrotliEncoderParameter.BROTLI_PARAM_CATABLE, compressionOptions.Catable ? (uint)1 : 0);
            _encoder.SetParameter(BrotliEncoderParameter.BROTLI_PARAM_APPENDABLE, compressionOptions.Appendable ? (uint)1 : 0);
            _encoder.SetParameter(BrotliEncoderParameter.BROTLI_PARAM_MAGIC_NUMBER, compressionOptions.MagicNumber ? (uint)1 : 0);
            _encoder.SetParameter(BrotliEncoderParameter.BROTLI_PARAM_BYTE_ALIGN, compressionOptions.ByteAlign ? (uint)1 : 0);
            _encoder.SetParameter(BrotliEncoderParameter.BROTLI_PARAM_BARE_STREAM, compressionOptions.Bare ? (uint)1 : 0);
        }
